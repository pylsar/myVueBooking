    ...
    <div class="container">
        <div class="navtop">
            <div class="navtop__left">
                ...
                <span>Call us on (+123) 456 1500</span>
            </div>
            <div class="navtop__right">
                <div class="navtop__right-item">
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M3 8.25C3.41421 8.25 3.75 8.58579 3.75 9V15.75H14.25V9C14.25 8.58579 14.5858 8.25 15 8.25C15.4142 8.25 15.75 8.58579 15.75 9V16.5C15.75 16.9142 15.4142 17.25 15 17.25H3C2.58579 17.25 2.25 16.9142 2.25 16.5V9C2.25 8.58579 2.58579 8.25 3 8.25Z" fill="#333333"/>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M0.75 5.25C0.75 4.83579 1.08579 4.5 1.5 4.5H16.5C16.9142 4.5 17.25 4.83579 17.25 5.25V9C17.25 9.41421 16.9142 9.75 16.5 9.75H1.5C1.08579 9.75 0.75 9.41421 0.75 9V5.25ZM2.25 6V8.25H15.75V6H2.25Z" fill="#333333"/>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M9 4.5C9.41421 4.5 9.75 4.83579 9.75 5.25V16.5C9.75 16.9142 9.41421 17.25 9 17.25C8.58579 17.25 8.25 16.9142 8.25 16.5V5.25C8.25 4.83579 8.58579 4.5 9 4.5Z" fill="#333333"/>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M5.625 2.25C5.32663 2.25 5.04048 2.36853 4.8295 2.5795C4.61853 2.79048 4.5 3.07663 4.5 3.375C4.5 3.67337 4.61853 3.95952 4.8295 4.1705C5.04048 4.38147 5.32663 4.5 5.625 4.5H7.99052C7.89896 4.26046 7.78306 3.99706 7.63971 3.73644C7.16799 2.87876 6.52043 2.25 5.625 2.25ZM9 5.25C9.73544 5.10291 9.73538 5.10266 9.73533 5.10239L9.73491 5.10028L9.73409 5.09627L9.73157 5.0842C9.72949 5.07438 9.72662 5.06104 9.7229 5.04441C9.71548 5.01118 9.7047 4.96474 9.69025 4.90697C9.66141 4.79157 9.61774 4.63007 9.5568 4.43764C9.43579 4.05549 9.24248 3.53801 8.95404 3.01356C8.39451 1.99624 7.35457 0.75 5.625 0.75C4.92881 0.75 4.26113 1.02656 3.76884 1.51884C3.27656 2.01113 3 2.67881 3 3.375C3 4.07119 3.27656 4.73887 3.76884 5.23116C4.26113 5.72344 4.92881 6 5.625 6H9C9.2247 6 9.43755 5.89926 9.58001 5.72549C9.72246 5.55173 9.7794 5.32272 9.73533 5.10239L9 5.25Z" fill="#333333"/>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M9.04596 3.01356C9.60549 1.99624 10.6454 0.75 12.375 0.75C13.0712 0.75 13.7389 1.02656 14.2312 1.51884C14.7234 2.01113 15 2.67881 15 3.375C15 4.07119 14.7234 4.73887 14.2312 5.23116C13.7389 5.72344 13.0712 6 12.375 6H9C8.7753 6 8.56245 5.89926 8.41999 5.72549C8.27754 5.55173 8.2205 5.32324 8.26456 5.10291L9 5.25C8.26456 5.10291 8.26451 5.10318 8.26456 5.10291L8.26479 5.10177L8.26509 5.10028L8.26591 5.09627L8.26843 5.0842C8.27051 5.07438 8.27338 5.06104 8.2771 5.04441C8.28452 5.01118 8.2953 4.96474 8.30975 4.90697C8.33859 4.79157 8.38226 4.63007 8.4432 4.43764C8.56421 4.05549 8.75752 3.53801 9.04596 3.01356ZM10.0095 4.5H12.375C12.6734 4.5 12.9595 4.38147 13.1705 4.1705C13.3815 3.95952 13.5 3.67337 13.5 3.375C13.5 3.07663 13.3815 2.79048 13.1705 2.5795C12.9595 2.36853 12.6734 2.25 12.375 2.25C11.4796 2.25 10.832 2.87876 10.3603 3.73644C10.2169 3.99706 10.101 4.26046 10.0095 4.5ZM9.73518 5.39835C9.73513 5.39859 9.73514 5.39855 9.73518 5.39835V5.39835Z" fill="#333333"/>
                    </svg>
                    <span>not my design</span>
                </div>
                <div class="navtop__right-item">
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="https://github.com/pylsar/myVueBooking" target="_blank">code here</a>
                </div>
            </div>
        </div>
    </div>
